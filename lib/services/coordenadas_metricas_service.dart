...
class CoordenadasMetricasService {
  static const String _tabla = 'coordenadas_metricas';
  ...
  static Future<void> registrarConsulta({
    ...
    await registrarEvento(
      accion: 'consulta_coordenadas',
      criterio: criterio,
      valor: valor,
    );
  }

  static Future<void> registrarAbrirMaps(String coordenada) async {
    await registrarEvento(
